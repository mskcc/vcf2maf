...
ok( system( "docker run --rm -v $test_dir:/opt/tests vcf2maf:master perl vcf2maf.pl --vep-path /usr/local/bin --vep-data tests --ncbi-build GRCh38 --input-vcf tests/test_b38.vcf --output-maf tests/test_b38_output.new.maf --ref-fasta tests/Homo_sapiens.GRCh38.dna.chromosome.21.fa" ) == 0 );
