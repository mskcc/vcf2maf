...
ok( system( "perl vcf2maf.pl --online --ncbi-build GRCh38 --input-vcf tests/test_b38.vcf --output-maf tests/test_b38_output.online.new.maf --ref-fasta data/Homo_sapiens.GRCh38.dna.chromosome.13.fa 2> /dev/null" ) == 0 );
