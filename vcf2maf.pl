...
my ( $vep_path, $vep_data, $vep_forks, $buffer_size, $any_allele, $inhibit_vep, $online, $vep_custom, $vep_config, $vep_overwrite ) = ( "$ENV{HOME}/vep", "$ENV{HOME}/.vep", 4, 5000, 0, 0, 0, "", "", 0);
...
warn "STATUS: Preprocesing $input_vcf before passing to VEP...\n" if( $verbose );
