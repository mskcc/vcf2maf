...
my @ann_cols = qw( Allele Gene Feature Feature_type Consequence cDNA_position CDS_position
    ...
    TSL HGVS_OFFSET PHENO ExAC_AF ExAC_AMR_AF ExAC_FIN_AF ExAC_NFE_AF ExAC_AFR_AF ExAC_EAS_AF ExAC_SAS_AF ExAC_OTH_AF);
